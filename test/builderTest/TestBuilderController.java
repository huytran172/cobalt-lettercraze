...
public class TestBuilderController extends TestCase{
	...
	public void testBuilderController(){
		...
		dmf.main(null);
		builder.view.dropdownMenu.CustomConfirmButton ccb = new builder.view.dropdownMenu.CustomConfirmButton(1);
		ccb.setLevelNum(1);
		assertEquals(ccb.getLevelNum(),1);
		//Test Select Mode GUI
		builder.view.selectModeMenu.CustomConfirmButton btnNewButton = new builder.view.selectModeMenu.CustomConfirmButton(0);
		SelectModeMenuFrame smf = new SelectModeMenuFrame();
		smf.main(null);

		builder.view.selectModeMenu.CustomConfirmButton puzzle = new builder.view.selectModeMenu.CustomConfirmButton(0);
		System.out.println(puzzle.getLevelNum());
		assertEquals(puzzle.getLevelNum(), 1);
		
		builder.view.selectModeMenu.CustomConfirmButton lightning = new builder.view.selectModeMenu.CustomConfirmButton(1);
		assertEquals(lightning.getLevelNum(),2);
		
		builder.view.selectModeMenu.CustomConfirmButton theme = new builder.view.selectModeMenu.CustomConfirmButton(2);
